  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        />
        <Route
          path="/admin/genealogy/binary"
          element={<Navigate to="/admin/business/club" replace />}
        />
        <Route
          path="/admin/genealogy/sponsor"
          element={<Navigate to="/admin/business/enroller" replace />}
        />
        <Route
          path="/admin/genealogy/tree"
          element={<Navigate to="/admin/business/structure" replace />}
        />
        <Route
          path="/admin/genealogy/list"
          element={<Navigate to="/admin/business/list" replace />}
        />

        {/* Financial Routes */}
        <Route
          path="/admin/financial/e-wallet"
          element={
            <ProtectedRoute requiredRole="admin">
              <AdminEWallet />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/admin/financial/ewallet"
          element={<Navigate to="/admin/financial/e-wallet" replace />}
        />
        <Route
        ...
        />
        <Route
          path="/admin/financial/deposit"
          element={<Navigate to="/admin/financial/deposit-wallet" replace />}
        />
        <Route
        ...
        />
        <Route
          path="/admin/financial/fund-credit"
          element={<Navigate to="/admin/financial/fund-credits" replace />}
        />
        <Route
          path="/admin/financial/credit"
          element={<Navigate to="/admin/financial/fund-credits" replace />}
        />
        <Route
          path="/admin/financial/transfer"
          element={
            <ProtectedRoute requiredRole="admin">
              <AdminModulePage />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/admin/financial/payout/history"
          element={
            <ProtectedRoute requiredRole="admin">
              <AdminPayout />
            </ProtectedRoute>
        ...
        <Route
          ...
          element={<Navigate to="/admin/financial/payout/request" replace />}
        />
        <Route
        ...
        />
        <Route
          path="/admin/communication/faq"
          element={<Navigate to="/admin/communication/faqs" replace />}
        />
        <Route
        ...
        />
        <Route
          path="/admin/communication/mails/sent"
          element={
            <ProtectedRoute requiredRole="admin">
              <AdminEmails />
            </ProtectedRoute>
        ...
        <Route
          ...
          element={<Navigate to="/admin/communication/mails/inbox" replace />}
        />
        <Route
          path="/admin/communication/mails"
          element={<Navigate to="/admin/communication/mails/inbox" replace />}
        />
        <Route
          path="/admin/communication/help-center/tickets/:category"
          element={
            <ProtectedRoute requiredRole="admin">
              <AdminHelpCenter />
            </ProtectedRoute>
        ...
        />
        <Route
          path="/admin/communication/help-center"
          element={
            <Navigate
              to="/admin/communication/help-center/tickets/inprogress"
              replace
            />
          }
        />
        ...
        />
        <Route
          path="/admin/communication/article"
          element={<Navigate to="/admin/communication/articles" replace />}
        />

        {/* Deprecated redirects */}
        <Route
          path="/admin/communication/tickets"
          element={<Navigate to="/admin/communication/help-center" replace />}
        />
        <Route
